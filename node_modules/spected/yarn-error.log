Arguments: 
  /usr/local/bin/node /usr/local/bin/yarn login

PATH: 
  /usr/local/opt/php@5.6/bin:/usr/local/opt/php@5.6/sbin:/usr/local/opt/postgresql@9.5/bin:/usr/bin:/bin:/usr/sbin:/sbin:/usr/local/bin
...
Lockfile: 
  ...
  babel-core@6, babel-core@^6.25.0, babel-core@^6.26.0:
    version "6.26.3"
  ...
  resolve@^1.1.6, resolve@^1.10.0, resolve@^1.4.0, resolve@^1.5.0:
    version "1.10.1"
