  ...
  render() {
    return (
      <div className="carouselAcc">
        <Card inverse>
          <CardImg
            className="cardImgBiereMainDegrade"
            src={bierreMainDegrade}
            alt="Card image cap"
          />
          <CardImgOverlay className="cardImgOverlayPage">
            <CardText className="treasureEggs">
              {" "}
              datejokemaybephonemeforfreebeer
            </CardText>
            <CardText className="titleHome"> Bienvenue sur </CardText>
            <div>
              <CardImg className="logobrable" src={logoBrable} alt="Logo" />
            </div>
            <CardText className="textHome">
              {" "}
              La meilleure façon de commander et payer dans les bars. Profitez
              du moment !
            </CardText>
            <CardText className="treasureEggs">
              {" "}
            ...
            <CardText className="textFooterHome">
              {" "}
